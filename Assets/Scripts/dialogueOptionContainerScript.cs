...
//	public Color talkColor = Color.
	...
	// ------ MOMINTRO
		...
		c9.id = 9;
		c9.response = "'Maybe he's not so bad. Illij apparently he knows him. Helped where he lived before.'";
		...
		c11.thoughts = "Dammit... missed something again.";
